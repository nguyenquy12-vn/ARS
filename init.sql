...
VALUES (1, N'Lương thưởng tháng 13, bảo hiểm FPT Care, làm việc hybrid.', 1, '2026-07-20T14:01:29.7600073Z', N'Phát triển các hệ thống Web API quy mô lớn sử dụng .NET 8 và SQL Server.', '2027-12-31T23:59:59.0000000Z', 1, 1, N'Cầu Giấy, Hà Nội', 25000000, 15000000, N'Có kinh nghiệm lập trình C#, hiểu biết về Entity Framework Core, SQL Server. Biết Docker là một lợi thế.', 2, N'Kỹ Sư Lập Trình Backend .NET', 3, 3),
(2, N'Thưởng theo KPIs, môi trường trẻ trung năng động.', 1, '2026-07-20T14:01:29.7600073Z', N'Lên kế hoạch và triển khai các chiến dịch quảng cáo trên nền tảng Digital (Facebook, Google).', '2027-12-31T23:59:59.0000000Z', 3, 1, N'Thanh Xuân, Hà Nội', 20000000, 10000000, N'Tối thiểu 1 năm kinh nghiệm chạy Ads. Có khả năng sáng tạo nội dung.', 2, N'Chuyên viên Marketing Digital', 2, 1),
(3, N'Hoa hồng cao, phụ cấp ăn trưa và đi lại.', 1, '2026-07-20T14:01:29.7600073Z', N'Tư vấn sản phẩm dịch vụ của công ty đến với khách hàng qua điện thoại.', '2027-12-31T23:59:59.0000000Z', 2, 1, N'Đống Đa, Hà Nội', 15000000, 7000000, N'Giọng nói chuẩn, giao tiếp tốt, không yêu cầu kinh nghiệm (được đào tạo).', 2, N'Nhân viên Telesales', 5, 1),
(4, N'Hỗ trợ dấu mộc thực tập, trợ cấp 3 triệu/tháng, cơ hội lên nhân viên chính thức.', 1, '2026-07-20T14:01:29.7600073Z', N'Tham gia phát triển các tính năng Front-end cho dự án công ty bằng ReactJS.', '2027-12-31T23:59:59.0000000Z', 1, 3, N'Quận 1, TP. HCM', 5000000, 3000000, N'Sinh viên năm cuối hoặc mới ra trường, nắm chắc HTML/CSS/JS cơ bản.', 2, N'Thực tập sinh ReactJS', 4, 2),
(5, N'Chế độ BHYT, BHXH đầy đủ, thưởng lễ tết hấp dẫn.', 1, '2026-07-20T14:01:29.7600073Z', N'Chịu trách nhiệm kiểm tra đối chiếu số liệu, lập báo cáo tài chính hàng tháng/quý.', '2027-12-31T23:59:59.0000000Z', 4, 1, N'Hải Châu, Đà Nẵng', 18000000, 12000000, N'Tốt nghiệp đại học chuyên ngành Kế toán, trên 3 năm kinh nghiệm làm tổng hợp.', 2, N'Kế toán tổng hợp', 1, 1);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Benefits', N'CompanyId', N'CreatedAt', N'Description', N'ExpiredAt', N'JobCategoryId', N'JobType', N'Location', N'MaxSalary', N'MinSalary', N'Requirements', N'Status', N'Title', N'Vacancies', N'WorkMode') AND [object_id] = OBJECT_ID(N'[JobPostings]'))
...
UPDATE [JobPostings] SET [CreatedAt] = '2026-01-01T00:00:00.0000000Z', [ExpiredAt] = '2027-12-31T23:59:59.0000000Z'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;
